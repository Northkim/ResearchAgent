"""Publish immutable Real Writing Definition 0.3 and Capsule 0.5.
...
down_revision: str | None = "20260815_0023"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

WORKFLOW_ID = "writing-local-experimental"
VERSION = "0.3.0"
CONTRACT_CHECKSUM = "sha256:6d0142be692570bcf11569d557e8a87821d45e84936a3cff549fab5f378a7223"
CAPSULE_ID = "capsule-3f94b97702190efed2a4fcd2c0e5f770"
CAPSULE_VERSION = "0.5.0"
CAPSULE_CHECKSUM = "sha256:3f94b97702190efed2a4fcd2c0e5f770eaf64020a56ec5f14eaf41412314e8ad"
...
HISTORICAL_CAPSULE_CHECKSUM = "sha256:f7c206e79a3fe8a1831138a43ee46f1b44c5c3d193646382db5c25dbd9542269"
...
def upgrade() -> None:
    ...
    connection.execute(sa.text("""
        ...
        VALUES (:id, :version, :checksum, 'artifact-bindings/v0.1',
                'manuscript-draft/v2', CAST(:compatibility AS jsonb),
    ...
    connection.execute(sa.text("""
        ...
        VALUES (:id, :version, 0, :skill_id, :skill_version, :skill_checksum,
                'Use exact bound evidence and preserve Artifact provenance.', :now)
...
def _assert_preconditions(connection: sa.Connection) -> None:
    ...
    if historical != HISTORICAL_CAPSULE_CHECKSUM:
        raise RuntimeError("Real Writing requires the accepted immutable 0.2/0.4 Capsule")
...
def _assert_seed(connection: sa.Connection) -> None:
    ...
    expected = {
        ...
        "output_schema_id": "manuscript-draft/v2",
        "core_capability_maturity": "REVIEWED_CORE",
        "capsule_id": CAPSULE_ID, "capsule_version": CAPSULE_VERSION,
        "definition_checksum": CAPSULE_CHECKSUM, "artifact_count": 3,
    }
    if row is None or dict(row) != expected:
        raise RuntimeError("Real Writing immutable seed conflict")
